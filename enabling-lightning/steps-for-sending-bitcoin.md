# Withdrawing Your Sats

There are two options to withdraw sats that will be presented. There are more, but they are much more complicated.

### Option 1 : Sell sats for fiat with Bull Bitcoin

{% hint style="success" %}
On [bullbitcoin.com](https://bullbitcoin.com) , you can sell your sats using the lightning network and receive fiat in any Canadian bank account or pay a bill on the same or next business day.&#x20;
{% endhint %}
...
### Option 2 : Sends sats to an external wallet to convert into on-chain Bitcoin

#### Wallet 1 : Blue Wallet

Once you created a Lightning wallet in Blue Wallet, create an invoice to paste into RTL by clicking on `Receive`(like instructions described above).

Once you have funds in your lightning wallet, click on “Manage Funds” (in the lightning wallet).

Now click on “Exchange”. This will open up a website where you can send Bitcoin on the Lightning Network and they will send you an equivalent minus fees to a Bitcoin address that you enter.&#x20;

#### Wallet 2 : Breez Wallet

Once you created a Lightning wallet in Breez Wallet, create an Invoice to paste into RTL by clicking on `Receive`(like instructions described above).

{% hint style="warning" %}
They will charge a small processing fee that is only applicable to the first transaction.&#x20;
{% endhint %}

* Now that you have sats in your lightning wallet, click on `Send`.
